...
import { BacklogIcon, BoardIcon, RoadmapIcon } from "./svgs";
import {
  NavigationMenu,
  NavigationMenuLink,
  NavigationMenuList,
...
import { FaGripfire , FaChevronRight } from "react-icons/fa";
  ...
  return (
    <div className="flex h-full w-64 flex-col gap-y-5 bg-gray-50 p-3 shadow-inner">
      <div className="my-5 flex items-center gap-x-2 px-3">
        <div className="mt-1 flex items-center justify-center rounded-sm bg-[#825BEF] p-1 text-xs font-bold text-white">
